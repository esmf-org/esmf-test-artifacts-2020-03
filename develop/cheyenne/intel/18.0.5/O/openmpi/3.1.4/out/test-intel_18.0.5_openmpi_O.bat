...
ssh cheyenne6 /glade/scratch/rlong/esmf-testing//glade/scratch/rlong/esmf-testing/intel_18.0.5_openmpi_O_develop/getres-int.sh
...
ssh cheyenne6 /glade/scratch/rlong/esmf-testing/intel_18.0.5_openmpi_O_develop/runpython.sh 2>&1 | tee python_build.log
