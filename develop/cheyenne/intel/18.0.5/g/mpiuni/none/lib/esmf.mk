build time -- 2022-02-18 06:21:05.844165
...
ESMF_APPSDIR=/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop/apps/appsg/Linux.intel.64.mpiuni.default
ESMF_LIBSDIR=/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_F90LINKPATHS=-L/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop/lib/libg/Linux.intel.64.mpiuni.default -L/glade/u/apps/ch/opt/netcdf/4.8.1/intel/19.1.1/lib -L/glade/u/apps/ch/opt/netcdf/4.8.1/intel/19.1.1/lib 
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop/lib/libg/Linux.intel.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop/lib/libg/Linux.intel.64.mpiuni.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/intel/19.1.1/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/intel/19.1.1/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop/lib/libg/Linux.intel.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop/lib/libg/Linux.intel.64.mpiuni.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/intel/19.1.1/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.8.1/intel/19.1.1/lib -Wl,-rpath,/glade/u/apps/opt/intel/2020u1/compilers_and_libraries_2020.1.217/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop/lib/libg/Linux.intel.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop
ESMF_INTERNAL_MPIRUN=/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop/src/Infrastructure/stubs/mpiuni/mpirun

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/rlong/esmf-testing/intel_18.0.5_mpiuni_g_develop
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
