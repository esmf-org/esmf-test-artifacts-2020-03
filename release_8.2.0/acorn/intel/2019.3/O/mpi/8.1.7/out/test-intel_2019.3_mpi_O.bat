...
ssh alogin01 /lfs/h1/emc/ptmp/Mark.Potts//lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_release_8.2.0/getres-int.sh
...
ssh alogin01 /lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_O_release_8.2.0/runpython.sh 2>&1 | tee python_build.log
