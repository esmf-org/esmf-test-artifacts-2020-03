...
cd /lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_g_release_8.2.0
...
export ESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_g_release_8.2.0
...
ssh alogin01 /lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_g_release_8.2.0/runpython.sh 2>&1 | tee python_build.log
