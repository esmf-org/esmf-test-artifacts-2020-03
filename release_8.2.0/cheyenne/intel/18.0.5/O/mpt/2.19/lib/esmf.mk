build time -- 2021-10-20 04:10:22.360983
...
ESMF_APPSDIR=/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/apps/appsO/Linux.intel.64.mpt.default
ESMF_LIBSDIR=/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/lib/libO/Linux.intel.64.mpt.default
...
ESMF_F90LINKPATHS=-L/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/lib/libO/Linux.intel.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib 
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/lib/libO/Linux.intel.64.mpt.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/lib/libO/Linux.intel.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/lib/libO/Linux.intel.64.mpt.default
...
ESMF_CXXCOMPILEPATHS= -I/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/src/include  -I/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/include -I/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_22-14-g268d7953a2' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpt -DESMF_DIR=/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0 -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/lib/libO/Linux.intel.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib -L/glade/u/apps/opt/intel/2018u4/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/lib/libO/Linux.intel.64.mpt.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/lib/libO/Linux.intel.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib -Wl,-rpath,/glade/u/apps/opt/intel/2018u4/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/lib/libO/Linux.intel.64.mpt.default
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0/lib/libO/Linux.intel.64.mpt.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0
ESMF_INTERNAL_MPIRUN=mpirun 

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/mpotts/intel_18.0.5_mpt_O_release_8.2.0
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
