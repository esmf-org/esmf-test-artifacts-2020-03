build time -- 2021-10-14 18:28:41.219258
...
ESMF_APPSDIR=/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/apps/appsg/Unicos.intel.64.mpi.default
ESMF_LIBSDIR=/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/lib/libg/Unicos.intel.64.mpi.default
...
ESMF_F90COMPILEPATHS=-I/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/mod/modg/Unicos.intel.64.mpi.default -I/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/src/include -I/opt/cray/pe/netcdf/4.6.3.2/include -I/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_22-10-g6974ca47a6' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0
...
ESMF_F90LINKPATHS=-L/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/lib/libg/Unicos.intel.64.mpi.default -L/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib 
ESMF_F90ESMFLINKPATHS=-L/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/lib/libg/Unicos.intel.64.mpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/lib/libg/Unicos.intel.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/lib/libg/Unicos.intel.64.mpi.default
...
ESMF_CXXCOMPILEPATHS= -I/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/src/include  -I/opt/cray/pe/netcdf/4.6.3.2/include -I/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_2_0_beta_snapshot_22-10-g6974ca47a6' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0 -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_POSIXIPC

ESMF_CXXLINKOPTS=  -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/lib/libg/Unicos.intel.64.mpi.default -L/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib -L/opt/intel/compilers_and_libraries_2019.3.199/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/lib/libg/Unicos.intel.64.mpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/lib/libg/Unicos.intel.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/lib/libg/Unicos.intel.64.mpi.default
...
ESMF_TRACE_LDPRELOAD=/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/lib/libg/Unicos.intel.64.mpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0
ESMF_INTERNAL_MPIRUN=/global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0/scripts/mpirun.srun 

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /global/u2/r/rsdunlap/esmf-testing/intel_19.0.3_mpi_g_release_8.2.0
# ESMF_OS: Unicos
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
