...
export ESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0
...
ssh gaea14 /lustre/f2/dev/ncep/Mark.Potts//lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/getres-int.sh
