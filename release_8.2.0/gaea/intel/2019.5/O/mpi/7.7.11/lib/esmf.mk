build time -- 2021-10-07 00:39:17
...
ESMF_LIBSDIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_F90COMPILEPATHS=-I/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/mod/modO/Unicos.intel.64.mpi.default -I/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/src/include -I/opt/cray/pe/netcdf/4.6.3.2/include -I/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0
...
ESMF_F90LINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/lib/libO/Unicos.intel.64.mpi.default -L/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib 
ESMF_F90ESMFLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/lib/libO/Unicos.intel.64.mpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/lib/libO/Unicos.intel.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_CXXCOMPILEPATHS= -I/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/src/include  -I/opt/cray/pe/netcdf/4.6.3.2/include -I/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0 -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_POSIXIPC

ESMF_CXXLINKOPTS=  -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/lib/libO/Unicos.intel.64.mpi.default -L/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib -L/opt/intel/compilers_and_libraries_2019.5.281/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/lib/libO/Unicos.intel.64.mpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/lib/libO/Unicos.intel.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_TRACE_LDPRELOAD=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/lib/libO/Unicos.intel.64.mpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0
ESMF_INTERNAL_MPIRUN=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0/scripts/mpirun.srun 

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O_release_8.2.0
# ESMF_OS: Unicos
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
