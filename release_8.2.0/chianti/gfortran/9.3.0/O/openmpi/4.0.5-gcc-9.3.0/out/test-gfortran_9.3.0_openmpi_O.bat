...
export ESMF_DIR=/home/mpotts/gfortran_9.3.0_openmpi_O_release_8.2.0
...
ssh chianti /home/mpotts//home/mpotts/gfortran_9.3.0_openmpi_O_release_8.2.0/getres-int.sh
