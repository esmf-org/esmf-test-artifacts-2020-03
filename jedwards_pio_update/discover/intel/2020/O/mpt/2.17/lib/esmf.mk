build time -- 2022-01-19 01:14:30.063681
...
ESMF_APPSDIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/apps/appsO/Linux.intel.64.mpt.default
ESMF_LIBSDIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/lib/libO/Linux.intel.64.mpt.default
...
ESMF_F90COMPILEPATHS=-I/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/mod/modO/Linux.intel.64.mpt.default -I/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/src/include -I/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/include -I/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_3_0_beta_snapshot_05-100-g65e948c47d' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpt -DESMF_DIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update
...
ESMF_F90LINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/lib/libO/Linux.intel.64.mpt.default -L/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib -L/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib 
ESMF_F90ESMFLINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/lib/libO/Linux.intel.64.mpt.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/lib/libO/Linux.intel.64.mpt.default -Wl,-rpath,/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib -Wl,-rpath,/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/lib/libO/Linux.intel.64.mpt.default
...
ESMF_CXXCOMPILEPATHS= -I/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/src/include  -I/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/include -I/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_3_0_beta_snapshot_05-100-g65e948c47d' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpt -DESMF_DIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/lib/libO/Linux.intel.64.mpt.default -L/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib -L/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib -L/gpfsm/dulocal/sles12/intel/2020/compilers_and_libraries_2020.4.304/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/lib/libO/Linux.intel.64.mpt.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/lib/libO/Linux.intel.64.mpt.default -Wl,-rpath,/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib -Wl,-rpath,/usr/local/other/netcdf4/4.7.4/intel/19.1.3.304/lib  -Wl,-rpath,/gpfsm/dulocal/sles12/intel/2020/compilers_and_libraries_2020.4.304/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/lib/libO/Linux.intel.64.mpt.default
...
ESMF_TRACE_LDPRELOAD=/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update/lib/libO/Linux.intel.64.mpt.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update
ESMF_INTERNAL_MPIRUN=mpirun 

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /gpfsm/dnb04/projects/p98/mpotts/esmf/intel_2020_mpt_O_jedwards_pio_update
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
