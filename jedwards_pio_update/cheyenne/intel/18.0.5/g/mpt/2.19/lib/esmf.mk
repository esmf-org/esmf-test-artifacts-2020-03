build time -- 2022-02-17 06:30:55.091390
...
ESMF_APPSDIR=/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/apps/appsg/Linux.intel.64.mpt.default
ESMF_LIBSDIR=/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/lib/libg/Linux.intel.64.mpt.default
...
ESMF_F90LINKPATHS=-L/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/lib/libg/Linux.intel.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib 
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/lib/libg/Linux.intel.64.mpt.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/lib/libg/Linux.intel.64.mpt.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/lib/libg/Linux.intel.64.mpt.default
...
ESMF_CXXCOMPILEPATHS= -I/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/src/include  -I/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/include -I/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='ESMF_8_3_0_beta_snapshot_06-85-gae1d61de23' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpt -DESMF_DIR=/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update -D__SDIR__='' -DESMF_CXXSTD=11

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/lib/libg/Linux.intel.64.mpt.default -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib -L/glade/u/apps/opt/intel/2018u4/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/lib/libg/Linux.intel.64.mpt.default
...
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/lib/libg/Linux.intel.64.mpt.default
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update/lib/libg/Linux.intel.64.mpt.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update
ESMF_INTERNAL_MPIRUN=mpirun -p %g: 

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/rlong/esmf-testing/intel_18.0.5_mpt_g_jedwards_pio_update
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
