...
export ESMF_MPIRUN=/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_mpiuni_O_main/src/Infrastructure/stubs/mpiuni/mpirun
...
export ESMF_DIR=/scratch1/NCEPDEV/stmp2/Mark.Potts/gfortran_9.2.0_mpiuni_O_main
