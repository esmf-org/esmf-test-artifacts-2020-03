...
export ESMF_DIR=/scratch1/NCEPDEV/stmp2/Mark.Potts/intel_18.0.4_intelmpi_O_main
...
ssh hfe10 /scratch1/NCEPDEV/stmp2/Mark.Potts/intel_18.0.4_intelmpi_O_main/runpython.sh 2>&1 | tee python_build.log
