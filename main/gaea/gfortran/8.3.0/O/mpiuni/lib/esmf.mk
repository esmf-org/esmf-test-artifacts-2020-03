build time -- 2021-10-29 00:29:36
...
ESMF_APPSDIR=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/apps/appsO/Unicos.gfortran.64.mpiuni.default
ESMF_LIBSDIR=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/lib/libO/Unicos.gfortran.64.mpiuni.default
...
ESMF_F90COMPILEPATHS=-I/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/mod/modO/Unicos.gfortran.64.mpiuni.default -I/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/src/include -I/opt/cray/pe/netcdf/4.6.3.2/include -I/opt/cray/pe/netcdf/4.6.3.2/GNU/8.2/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpiuni -DESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main -DESMF_MPIUNI
...
ESMF_F90LINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/lib/libO/Unicos.gfortran.64.mpiuni.default -L/opt/cray/pe/netcdf/4.6.3.2/GNU/8.2/lib -L/opt/gcc/8.3.0/snos/lib/gcc/x86_64-suse-linux/8.3.0/../../../../lib64/
ESMF_F90ESMFLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/lib/libO/Unicos.gfortran.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/lib/libO/Unicos.gfortran.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf/4.6.3.2/GNU/8.2/lib -Wl,-rpath,/opt/gcc/8.3.0/snos/lib/gcc/x86_64-suse-linux/8.3.0/../../../../lib64/
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/lib/libO/Unicos.gfortran.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/src/include  -I/opt/cray/pe/netcdf/4.6.3.2/include -I/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/src/Infrastructure/stubs/mpiuni -I/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpiuni -DESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_MPIUNI -DESMF_NO_POSIXIPC

ESMF_CXXLINKOPTS=  -pthread  -fopenmp
ESMF_CXXLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/lib/libO/Unicos.gfortran.64.mpiuni.default -L/opt/cray/pe/netcdf/4.6.3.2/GNU/8.2/lib -L/opt/gcc/8.3.0/snos/lib/gcc/x86_64-suse-linux/8.3.0/../../../../lib64/
ESMF_CXXESMFLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/lib/libO/Unicos.gfortran.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/lib/libO/Unicos.gfortran.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf/4.6.3.2/GNU/8.2/lib -Wl,-rpath,/opt/gcc/8.3.0/snos/lib/gcc/x86_64-suse-linux/8.3.0/../../../../lib64/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/lib/libO/Unicos.gfortran.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/lib/libO/Unicos.gfortran.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main
ESMF_INTERNAL_MPIRUN=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main/src/Infrastructure/stubs/mpiuni/mpirun

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpiuni_O_main
# ESMF_OS: Unicos
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
