...
cd /lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_g_main
...
export ESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_g_main
...
ssh alogin01 /lfs/h1/emc/ptmp/Mark.Potts/intel_2019.3_mpi_g_main/runpython.sh 2>&1 | tee python_build.log
