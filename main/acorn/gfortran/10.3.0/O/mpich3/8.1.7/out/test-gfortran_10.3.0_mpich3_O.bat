...
cd /lfs/h1/emc/ptmp/Mark.Potts/gfortran_10.3.0_mpich3_O_main
...
export ESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/gfortran_10.3.0_mpich3_O_main
...
ssh alogin01 /lfs/h1/emc/ptmp/Mark.Potts/gfortran_10.3.0_mpich3_O_main/runpython.sh 2>&1 | tee python_build.log
