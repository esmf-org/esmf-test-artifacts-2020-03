Thu 03 Mar 2022 03:16:05 PM UTC
#!/bin/sh -l
...
ssh alogin01 /lfs/h1/emc/ptmp/Mark.Potts/gfortran_10.3.0_mpich3_g_jedwards_pio_update2/runpython.sh 2>&1 | tee python_build.log
