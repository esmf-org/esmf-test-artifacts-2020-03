build time -- 2022-02-26 23:28:54
...
ESMF_APPSDIR=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/apps/appsO/Unicos.gfortran.64.mpi.default
ESMF_LIBSDIR=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/lib/libO/Unicos.gfortran.64.mpi.default
...
ESMF_F90COMPILEPATHS=-I/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/mod/modO/Unicos.gfortran.64.mpi.default -I/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/src/include -I/opt/cray/pe/netcdf/4.6.3.2/include -I/opt/cray/pe/netcdf/4.6.3.2/GNU/8.2/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b08-90-g763a12848c' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2
...
ESMF_F90LINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/lib/libO/Unicos.gfortran.64.mpi.default -L/opt/cray/pe/netcdf/4.6.3.2/GNU/8.2/lib -L/opt/gcc/8.3.0/snos/lib/gcc/x86_64-suse-linux/8.3.0/../../../../lib64/
ESMF_F90ESMFLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/lib/libO/Unicos.gfortran.64.mpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/lib/libO/Unicos.gfortran.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.6.3.2/GNU/8.2/lib  -Wl,-rpath,/opt/gcc/8.3.0/snos/lib/gcc/x86_64-suse-linux/8.3.0/../../../../lib64/
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/lib/libO/Unicos.gfortran.64.mpi.default
...
ESMF_CXXCOMPILEPATHS= -I/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/src/include  -I/opt/cray/pe/netcdf/4.6.3.2/include -I/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.0b08-90-g763a12848c' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2 -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_POSIXIPC

ESMF_CXXLINKOPTS=  -pthread  -fopenmp
ESMF_CXXLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/lib/libO/Unicos.gfortran.64.mpi.default -L/opt/cray/pe/netcdf/4.6.3.2/GNU/8.2/lib -L/opt/gcc/8.3.0/snos/lib/gcc/x86_64-suse-linux/8.3.0/../../../../lib64/
ESMF_CXXESMFLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/lib/libO/Unicos.gfortran.64.mpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/lib/libO/Unicos.gfortran.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.6.3.2/GNU/8.2/lib  -Wl,-rpath,/opt/gcc/8.3.0/snos/lib/gcc/x86_64-suse-linux/8.3.0/../../../../lib64/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/lib/libO/Unicos.gfortran.64.mpi.default
...
ESMF_TRACE_LDPRELOAD=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/lib/libO/Unicos.gfortran.64.mpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2
ESMF_INTERNAL_MPIRUN=/lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2/scripts/mpirun.srun 

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /lustre/f2/dev/ncep/Mark.Potts/gfortran_8.3.0_mpi_O_jedwards_pio_update2
# ESMF_OS: Unicos
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
